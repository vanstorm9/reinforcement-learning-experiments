...
def determine_turn(turn, observation_n, j, total_sum, prev_total_sum, reward_n):
	# for every 15 iterations, sum the toal observations and take the average
...
def main():
	...
	env = gym.make('flashgames.CoasterRacer-v0') #Virtual Network Environment
	observation_n = env.reset()

	#init variables
	# num of games iterations
	n = 0
	j = 0
