...
class PolicyGradientAgent():
    def __init__(self,lr,input_dims, gamma=0.99,n_actions=4):
        ...
        # load weights
        self.policy = T.load("model-saved.pth")
        self.policy.eval()
    ...
    def choose_action(self,observation):
        ...
        action_probs = T.distributions.Categorical(probabilities)  #We have to use this to select an action
    ...
    def learn(self):
        ...
        # G_t = R_t + gamma *R_t+2 + gamma**2 * R_t+3
